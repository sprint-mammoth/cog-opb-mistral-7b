...
class Predictor(BasePredictor):
    ...
    def setup(self):
        ...
        self.lm_model = AutoModelForCausalLM.from_pretrained("/root/openbuddy",
                                                    device_map="auto",
                                                    trust_remote_code=False,
                                                    revision="main")
        self.tokenizer = AutoTokenizer.from_pretrained("/root/openbuddy", use_fast=True, cache_dir="/root/openbuddy")
